...
(function() {
  var StormData, StormRegistry, SwitchBuilder, SwitchData, SwitchRegistry, brctl, delLink, netem, ovs, util,
      ...
      if (sdata.data.make === "openvswitch") {
        ...
        if (sdata.data.controller != null) {
          bridge.setController(sdata.data.name, sdata.data.controller, (function(_this) {
            return function(result) {
              util.log(result);
              return bridge.setOFVersion(sdata.data.name, sdata.data.ofversion, function(res) {
                return util.log(res);
              });
            };
          })(this));
