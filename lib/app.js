...
(function() {
  var DeviceDel, DeviceGet, DeviceStart, DeviceStop, argv, async, config, fs, log, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, restify, server, systemcheck, testSuiteDelete, testSuiteGet, testSuiteList, testSuitePost, topology, topologyDelete, topologyGet, topologyList, topologyPost, util;
  ...
  config = {
    ...
    ofversion: (ref8 = argv.O) === 1.0 || ref8 === 1.1 || ref8 === 1.2 || ref8 === 1.3 ? argv.O : null
  };
    ...
    return async.series([
      (function(_this) {
        return function(callback) {
          ...
          return container.exists(function(result) {
            if (result === true) {
