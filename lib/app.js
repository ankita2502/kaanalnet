...
(function() {
  var DeviceDel, DeviceGet, DeviceStart, DeviceStop, argv, config, fs, log, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, restify, server, systemcheck, topology, topologyDelete, topologyGet, topologyList, topologyPost, util;
