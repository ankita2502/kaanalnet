...
(function() {
  var argv, config, fs, log, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, restify, server, systemcheck, topology, topologyDelete, topologyGet, topologyList, topologyPost, util;
  ...
  config = {
    ...
    loglevel: (ref1 = argv.z) === 'trace' || ref1 === 'debug' || ref1 === 'info' || ref1 === 'warn' || ref1 === 'error' ? argv.z : 'debug',
    ...
    lxcimage: (ref7 = argv.I) != null ? ref7 : 'device'
  };
