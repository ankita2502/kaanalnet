...
(function() {
  ...
  node = (function() {
    ...
    node.prototype.addLagInterface = function(brname, ipaddress, subnetmask, gateway, characterstics) {
      var lagif;
      lagif = {
        "lagif1": "leth" + this.lagindex,
        "hwAddress1": getHwAddress(),
        "veth1": this.config.name + "_lveth" + this.lagindex,
        "lagif2": "leth" + this.lagindex,
        "hwAddress2": getHwAddress(),
        "veth2": this.config.name + "_lveth" + this.lagindex,
        "brname": brname,
        "ipaddress": ipaddress,
        "netmask": subnetmask,
        "gateway": gateway != null ? gateway : void 0,
