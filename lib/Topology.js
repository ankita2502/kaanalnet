...
(function() {
  ...
  Topology = (function() {
    ...
    Topology.prototype.getTestStatus = function(callback) {
      var i, len, ref, t, teststatus;
      teststatus = [];
      ref = this.testobjs;
      for (i = 0, len = ref.length; i < len; i++) {
        t = ref[i];
  ...
  TopologyMaster = (function() {
    ...
    TopologyMaster.prototype.testSuiteGet = function(topolid, data, callback) {
      var obj;
      obj = this.topologyObj[topolid];
      if (obj != null) {
        obj.getTestStatus(data, (function(_this) {
          return function(result) {};
        })(this));
        return callback(result);
      } else {
