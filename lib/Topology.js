...
(function() {
  var IPManager, TestSchema, Topology, TopologyMaster, TopologySchema, assert, async, extend, ip, keystore, log, node, request, sindex, switches, test, util, x;
          ...
          results.push((function() {
            ...
            for (k = 0, len1 = ref1.length; k < len1; k++) {
              ...
              if (obj != null) {
                ...
                if (n.lag != null) {
                  obj.addLagInterface(sw.name, startaddress, temp.subnetMask, temp.firstAddress, n.config);
                }
