...
(function() {
  var IPManager, StormData, StormRegistry, TestSchema, Topology, TopologyData, TopologyMaster, TopologyRegistry, assert, async, extend, ip, keystore, log, node, request, sindex, switches, test, util, x,
