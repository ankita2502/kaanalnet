...
(function() {
  var extend, log, request, switchctrl, switches, util;
  ...
  switches = (function() {
    ...
    switches.prototype.addTapInterface = function(ifname) {
      if (ifname != null) {
        this.tapifs.push(ifname);
      }
    };
    ...
    switches.prototype.connectTapInterfaces = function(callback) {
      ...
      for (i = 0, len = ref.length; i < len; i++) {
        tapif = ref[i];
        this.connect(tapif, (function(_this) {
